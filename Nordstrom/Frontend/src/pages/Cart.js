...
import { removeFromCarts, cartReset } from "../redux/CartPage/action";
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <Button
                ...
                ml={3}
                onClick={() => {
                  dispatch(removeFromCarts(product._id));
                  onClose();
                }}
              >
                Remove
            ...
            <Grid templateColumns={"repeat(5, 1fr)"} gap="6">
              <GridItem colSpan={{ base: 5, md: 3 }}>
                ...
                >
                  ...
                  <Text color={"gray.500"} mt="4" fontSize="12px">
                    <FontAwesomeIcon icon={faDotCircle} />{" "}
                    <Text as="span" fontWeight="bold">
                      &nbsp; 10% Instant Discount On ICICI Bank Credit Cards On
                  ...
                  <Text color={"gray.500"} mt="4" fontSize="12px">
                    <FontAwesomeIcon icon={faDotCircle} />{" "}
                    <Text as="span" fontWeight="bold">
                      &nbsp; 10% Cashback upto Rs 150 on Ola Money Postpaid or
                      wallet transaction on a min spend of Rs 1000 . TCA
                    </Text>
                  </Text>
                </Box>
                <Box
                ...
                >
                  <Text color={"gray.600"} fontSize="13px">
                    <FontAwesomeIcon icon={faTruck} /> &nbsp; Yay!{" "}
                    <Text as="span" fontWeight="bold">
                      No Convenience Fee{" "}
                    </Text>
                    On This Order
                    ...
                    >
                      ...
                      >
                        ...
                        <Box p="4" colSpan="2">
                          ...
                          <Text fontSize="13px" mt={1} fontWeight="thin">
                            {item.tagline}
                          </Text>
                          <Text fontSize="11px" mt={1} fontWeight="thin">
                          ...
                          <Flex gap={1} alignItems="center">
                            ...
                            <Text
                              ...
                              mt="6px"
                            >
                              ({((item.price * 100) / item.mrp).toFixed(0)}%
                              OFF)
                            </Text>
                          </Flex>
                          <Text fontSize="11px" mt={1} fontWeight="thin">
                            <FontAwesomeIcon
                              ...
                              color="teal"
                            />{" "}
                            Delivered By <strong>{currentDate}</strong>
                          </Text>
                        </Box>
                      </Box>
                    </Box>
              ...
              <GridItem colSpan={{ base: 5, md: 2 }}>
                ...
                >
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <Text mt="3" fontSize="14px" color="#ff3c6f">
                        <Text as="span" fontWeight="bold">
                          ADD GIFT WRAP
                        </Text>
                      </Text>
                ...
                >
                  ...
                  <Flex justifyContent="space-between" mt={4}>
                    ...
                    <Text fontSize="14px" fontWeight="thin">
                      Rs.
                      {cart.reduce((acc, item) => acc + item.mrp, 0)}
                    </Text>
                  </Flex>
                  ...
                  <Flex justifyContent="space-between" mt={3}>
                    ...
                    <Text fontSize="14px" color="blue" fontWeight="thin">
                      Apply Now
                    </Text>
                  </Flex>
                  <Flex justifyContent="space-between" mt={3}>
