...
function Home() {
  ...
  return (
    <>
      ...
      <Img
        src="https://i.postimg.cc/fyLpbPyV/Screenshot-2022-10-09-152952.png"
        w="100%"
      />
      <Grid
      ...
      >
        ...
        {index === 1 ? (
          <Box
            ...
            top={{ base: "-100px", md: "-150px", lg: "-160px", xl: "-250px" }}
            left={{ base: "40px", md: "80px", lg: "120px", xl: "250px" }}
          >
            <Text
              fontWeight={700}
              fontSize={{ base: "14px" }}
